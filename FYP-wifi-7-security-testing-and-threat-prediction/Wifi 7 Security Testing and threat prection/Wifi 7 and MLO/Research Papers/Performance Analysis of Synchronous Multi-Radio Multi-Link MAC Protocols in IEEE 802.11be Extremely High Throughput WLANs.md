### "Performance Analysis of Synchronous Multi-Radio Multi-Link MAC Protocols in IEEE 802.11be Extremely High Throughput WLANs.pdf"

- **Authors**: Taewon Song, Taeyoon Kim
- **Source**: Appl. Sci. 2021, 11, 317

#### Summary

This paper analyzes synchronous multi-radio multi-link MAC protocols in IEEE 802.11be (Wi-Fi 7) for Extremely High Throughput (EHT) WLANs. It reviews Distributed Coordination Function (DCF) adaptations for multi-link operation and uses a Markov chain model to evaluate performance. The focus is on pros/cons of candidate protocols, emphasizing throughput gains and latency reductions for apps like mobile gaming/VR. It discusses the evolution from single-link DCF to multi-link in Wi-Fi 7.
